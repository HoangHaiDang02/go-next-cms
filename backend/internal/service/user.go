...
func (s *UserService) AssignRole(ctx context.Context, id, roleID int64) error { return s.users.AssignRole(ctx, id, roleID) }

func (s *UserService) RemoveRole(ctx context.Context, id, roleID int64) error { return s.users.RemoveRole(ctx, id, roleID) }
